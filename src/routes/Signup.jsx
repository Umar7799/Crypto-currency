    ...
    <div>
      <div className='max-w-[400px] mx-auto min-h-[600px] px-4 py-20'>
        ...
        <form onSubmit={handleSubmit}>
          <div className='my-4'>
            ...
            <div className='my-2 w-full relative rounded-2xl shadow-xl'>
              ...
              <MdOutlineEmail className='absolute right-2 top-3 text-gray-400' />
            </div>
          </div>
          <div className='my-4'>
            ...
            <div className='my-2 w-full relative rounded-2xl shadow-xl'>
              ...
              <BsFillLockFill className='absolute right-2 top-3 text-gray-400' />
            </div>
          </div>
        ...
        <p className='my-4 '>Already have an account?
          <Link to='/signin' className='text-accent'> Sign in</Link></p>
      </div>
    </div>
  )
}
